  ...
  return (
      <div id="Contact" className='bg-slate-700 py-20 w-full border-t-2 border-solid border-black'>
          <div className='flex flex-col md:ml-52 ml-10'>
              ...
              <ToastContainer />
                  <form  action="" method="post" onSubmit={handleSubmitbtn}  className='flex flex-col w-full p-4'>
                      ...
                      <div  className='py-3'><button type="submit"   className='bg-gradient-to-b from-cyan-500 to-blue-500 px-8 py-2 rounded-md shadow-md text-white cursor-pointer hover:scale-105'>Let's talk</button></div>
                  </form>
              </div>
          </div>
    </div>
